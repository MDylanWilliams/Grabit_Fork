...
func TestSLWith2Resources(t *testing.T) {
	...
	st1.Increment(0)
	time.Sleep(1 * time.Millisecond) // Give SL loop time to update fields.
...
func TestSLWith1000Resources(t *testing.T) {
	...
	assert.Contains(t, st2.GetStatusString(), "\r✔[████████████████████]          1000/1000 Resources          6.0 kB / 6.0 kB") // Test takes 1 or 2 seconds.
}
